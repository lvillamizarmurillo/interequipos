    ...
    return(
        <>
            ...
            <div className="flex my-5 flex-wrap w-full mb-8 border border-blue-600">
                ...
                <div className="flex flex-col w-3/12 border-l border-blue-700 my-4 ">
                    <div className="flex w-full h-2/6"><img src={logoAzul} alt="" className="flex" /></div>
